    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center px-6 relative">
      ...
      <div className="w-full max-w-md z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          <span className="font-heading font-extrabold text-2xl tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
            SHASHIKA PORTFOLIO
          </span>
