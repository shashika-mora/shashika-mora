  ...
  return (
    <aside className="w-64 bg-slate-950 border-r border-slate-900 flex flex-col h-screen fixed left-0 top-0 z-40">
      ...
      <div className="p-6 border-b border-slate-900">
        <Link href="/" className="font-heading font-extrabold text-xl tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
          SHASHIKA ADMIN
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-slate-900 space-y-2">
        <a
          href="https://shashika-portfolio-2026.web.app"
          target="_blank"
