...
export default function Dashboard() {
  ...
  const statCards = [
    { name: 'Blog Posts', value: stats.blogs, subtext: `${stats.blogsPublished} Published`, icon: FileText, color: 'text-indigo-400', bg: 'bg-indigo-950/20', link: '/admin/dashboard/blogs' },
    { name: 'Projects', value: stats.projects, subtext: `${stats.projectsFeatured} Featured`, icon: Briefcase, color: 'text-pink-400', bg: 'bg-pink-950/20', link: '/admin/dashboard/projects' },
    { name: 'Academic Records', value: stats.academics, subtext: 'Timeline Entries', icon: GraduationCap, color: 'text-purple-400', bg: 'bg-purple-950/20', link: '/admin/dashboard/academics' },
    { name: 'Messages', value: stats.messages, subtext: `${stats.messagesUnread} Unread`, icon: Mail, color: 'text-emerald-400', bg: 'bg-emerald-950/20', link: '/admin/dashboard/messages' },
  ];
